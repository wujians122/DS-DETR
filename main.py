...
def main(args):
    ...
    #lr_scheduler = torch.optim.lr_scheduler.CosineAnnealingLR(optimizer, 100, eta_min=1e-5, last_epoch=-1)
    ...
    print('111111111',len(dataset_train))
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        if args.output_dir:
            ...
            if (epoch + 1) % 1 == 0 or (epoch + 1) % 100 == 0:
